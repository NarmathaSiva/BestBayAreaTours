...
import org.sausalito.SausBookingPage;
import org.sausalito.SausHomePage;
...
public class SausalitoTestPage extends BaseClass{
	...
	private void tc5() throws InterruptedException {
		...
		SausHomePage sh = new SausHomePage();
		
		WebElement tours = sh.getTours();
		explicitWebDriverWait(50000, tours);
        movingCursor(tours);
        
        WebElement sausalito = sh.getSausalito();
        clickElement(sausalito);
	...
	@Test
	public void tc6() throws AWTException, InterruptedException {
		
		Thread.sleep(7000);
		
		SausBookingPage sb = new SausBookingPage();
